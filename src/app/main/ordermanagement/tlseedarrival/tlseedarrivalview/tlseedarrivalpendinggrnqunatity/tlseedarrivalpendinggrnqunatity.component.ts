...
@Component({
  selector: 'app-tlseedarrivalpendinggrnqunatity',
  templateUrl: './tlseedarrivalpendinggrnqunatity.component.html',
  styleUrls: ['./tlseedarrivalpendinggrnqunatity.component.scss']
})
export class TlseedarrivalpendinggrnqunatityComponent implements OnInit {
  ...
  dataSource_pending_grn: MatTableDataSource<Tlseedarrivalviewmodel>;
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,
              ...
              public dialogRef: MatDialogRef<TlseedarrivalpendinggrnqunatityComponent>) {

  }

  ngOnInit(): void {
    this.dataSource_pending_grn = new MatTableDataSource<Tlseedarrivalviewmodel>(this.data);
  ...
  confirm(){
    ...
    try {
      this.spinner.show();
      this.webApiHttp.Post(this.webApiHttp.ApiURLArray.TL_grn_putaway_auto_create,
        {TLSeedArrivalNo: this.dataSource_pending_grn.data[0].document_no,
